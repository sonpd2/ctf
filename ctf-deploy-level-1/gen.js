...
w(`etc/cron.d/${pick(["apache-sync","php-gc","systemd-update",".cache"])}`,
...
{ const M=[["/var/log","var/log"],["/var/www","var/www"],["/opt","opt"],["/root","root"],["/home","home"],["/etc/passwd","etc/passwd"],["/etc/ssh/sshd_config","etc/ssh/sshd_config"],["/etc/cron.d","etc/cron.d"],["/etc/systemd/system","etc/systemd/system"],[suid,suid.replace(/^\//,"")]];
